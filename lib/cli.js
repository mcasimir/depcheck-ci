...
var options = null;
var configPath = (0, _path.resolve)(process.cwd(), argv.config);
var targetPath = (0, _path.resolve)(process.cwd(), argv.target);
var packageJsonPath = (0, _path.resolve)(targetPath, 'package.json');
...
try {
  ...
  try {
    options = JSON.parse((0, _fs.readFileSync)(configPath));
  } catch (e) {
